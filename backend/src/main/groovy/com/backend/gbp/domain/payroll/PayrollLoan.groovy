...
@Entity
@Table(schema = "payroll", name = "payroll_loans")
class PayrollLoan extends PayrollAuditingEntity implements Serializable {
    ...
    @OneToMany(mappedBy = "payrollLoan")
    List<PayrollEmployeeLoan> employees = []
