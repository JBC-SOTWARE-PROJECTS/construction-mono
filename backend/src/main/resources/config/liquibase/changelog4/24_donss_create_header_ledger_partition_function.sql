CREATE OR REPLACE FUNCTION public.create_header_ledger_monthly_partitions(start_d date, end_d date)
 RETURNS void
 LANGUAGE plpgsql
AS $function$
DECLARE
    schema_name TEXT := 'accounting';
    table_name TEXT := 'header_ledger';
...
SELECT FROM create_header_ledger_monthly_partitions('2023-01-01','2024-12-01');
