...
import { InventoryPostReceivingtList } from "@/utility/inventory-helper";
import ColumnTitle from "../../common/columnTitle/columnTitle";
import dayjs from "dayjs";
import styled from "styled-components";

interface IProps {
  dataSource: InventoryPostReceivingtList[];
  loading: boolean;
  rowKey?: string;
}

export default function PostInventoryReceivingTable({
  dataSource,
  loading,
  rowKey,
}: IProps) {
  ...
  // ===================== columns ========================
  const columns: ColumnsType<InventoryPostReceivingtList> = [
    {
