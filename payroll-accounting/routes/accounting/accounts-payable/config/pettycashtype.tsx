...
export default function PettyCashTransactionComponent() {
  ...
  const upsertShowModal = (record?: ExpenseTransaction) => {
    let payload = { ...record, type: "PETTYCASH" };
  ...
  return (
    <PageContainer title="Petty Cash Transaction Type Configuration">
      <ProCard
        title="Petty Cash Type Transaction"
        headStyle={{
          flexWrap: "wrap",
        }}
        bordered
