...
export default function DebitMemoTransactionComponent() {
  ...
  const upsertShowModal = (record?: ExpenseTransaction) => {
    let payload = { ...record, type: "DEBITMEMO" };
  ...
  return (
    <PageContainer title="Debit Memo Transaction Type Configuration">
      <ProCard
        title="Debit Memo type Transaction"
        headStyle={{
          flexWrap: "wrap",
        }}
        bordered
