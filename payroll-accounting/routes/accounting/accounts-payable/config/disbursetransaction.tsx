...
export default function DisbursementTransactionComponent() {
  ...
  const upsertShowModal = (record?: ExpenseTransaction) => {
    let payload = { ...record, type: "DISBURSE" };
  ...
  return (
    <PageContainer title="Disbursement Expense Transaction Type Configuration">
      <ProCard
        title="Disbursement Type Transaction"
        headStyle={{
          flexWrap: "wrap",
        }}
        bordered
