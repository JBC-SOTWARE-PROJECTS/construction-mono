...
const MUTATION = gql`
  mutation ($payrollId: UUID, $status: PayrollStatus) {
    data: updatePayrollLoanStatus(payrollId: $payrollId, status: $status) {
      message
    }
  }
`;
...
function useUpdatePayrollLoanStatus(callBack?: (result: any) => void) {
...
export default useUpdatePayrollLoanStatus;
