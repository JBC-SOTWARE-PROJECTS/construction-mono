...
const IconWithTextCard = ({ cardColor, icon, title, subTitle, iconColor, loading }) => {
  return (
    <Widget styleName={`gx-card-full gx-p-3 gx-bg-${cardColor} gx-text-white`}>
      <div className="gx-media gx-align-items-center gx-flex-nowrap">
        ...
        <div className="gx-media-body">
          <h1 className="gx-fs-xxl gx-font-weight-semi-bold gx-mb-1 gx-text-white">{loading ? <LoadingOutlined /> : title}</h1>
