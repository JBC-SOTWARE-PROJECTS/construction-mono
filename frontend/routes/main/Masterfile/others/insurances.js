...
import InsuranceForm from "../dialogs/insuranceForm";
...
const GET_RECORDS = gql`
  query ($filter: String) {
    list: insuranceList(filter: $filter) {
      id
      code
      description
      is_active
...
const Insurances = ({ account }) => {
  ...
  const [modal, showModal] = dialogHook(InsuranceForm, (result) => {
    if (result) {
