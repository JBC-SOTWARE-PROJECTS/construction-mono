...
const AdminCashierContent = ({ account }) => {
        ...
        },
        {
            ...
            render: (txt, record) => (
                ...
                <Button
                    ...
                    type='danger'
                    size='small'
                    onClick={() => showModal({ show: true, myProps: { ...record, access: account?.user?.access } })}
                >
                    Void OR/SI
                </Button>,
                ]
    ...
    return (
        <Card title="Shifting Records" size="small">
            <Row>
                <Col span={24}>
                    <Table
                        loading={loading}
...
export default AdminCashierContent;
