    ...
    return (
        <CModal
            ...
            footer={[
                ...
                <Button form="custForm" key="submit" htmlType="submit" type="primary" loading={upsertLoading}>
                    Submit
                </Button>,
            ]}
        >
            ...
            >
                <Row>
                    ...
                    {/*  */}
                    <Col {...col2}>
                        <FormInput description={"Contact Person"}
                            name="contactPerson"
                            initialValue={props?.contactPerson}
                            placeholder="Contact Person" />
                    </Col>
                    <Col {...col2}>
                        <FormInput description={"Contact Person No."}
