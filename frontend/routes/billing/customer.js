...
import { Card, Row, Col, Table, Dropdown, Menu, Button, Input, message, Divider } from 'antd';
...
const CustomerContent = ({ account }) => {
    ...
    const [modal, showModal] = dialogHook(CustomerForm, (result) => { // item form
        if (result) {
    ...
    return (
        <Card title="Customer List" size="small"
            extra={
